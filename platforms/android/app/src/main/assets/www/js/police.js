...
function getFullMediaURL1() {
    playMP3(cordova.file.applicationDirectory + 'www/audio/police/1siren1.wav');
}
function getFullMediaURL2() {
    playMP3(cordova.file.applicationDirectory + 'www/audio/police/2siren2.wav');
}
function getFullMediaURL3() {
    playMP3(cordova.file.applicationDirectory + 'www/audio/police/3shotgun.wav');
}
function getFullMediaURL4() {
    playMP3(cordova.file.applicationDirectory + 'www/audio/police/4siren3.wav');
}
function getFullMediaURL5() {
    playMP3(cordova.file.applicationDirectory + 'www/audio/police/5911.wav');
}
function getFullMediaURL6() {
    playMP3(cordova.file.applicationDirectory + 'www/audio/police/6siren4.wav');
}
